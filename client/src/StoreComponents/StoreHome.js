...
import MainSplitContainer from "../SplitComponents/MainSplitContainer";
import IMG1 from './images/herobackground.png'
...
function Home() {  
  const [splitActive, setSplitActive] = React.useState(false)
    ...
    <div className="home">
      ...
      <div className="row">
          ...
          <Product
            ...
            image={img1}
            rating={4}
            openSplitPay={() => setSplitActive(true)}
            moreplease={true}
          />
          {splitActive && <MainSplitContainer fullPrice={1200} />}
           <Product
            id="8"
